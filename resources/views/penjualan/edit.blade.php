...
<style>
    ...
    .form-control, .form-select { width: 100%; padding: 10px 14px; font-size: 13px; color: #0f172a; background-color: #f8fafc; border: 1px solid #cbd5e1; border-radius: 8px; transition: all 0.2s; outline: none; }
...
<div class="form-container">
    <div class="form-header">
        <h3><i class="fas fa-edit"></i> Form Edit Penjualan</h3>
    </div>
                ...
                <div class="form-group">
                    ...
                    <select name="ID_PETUGAS" class="form-select" required>
                        ...
                        @foreach($petugas as $p)
                            <option value="{{ $p->ID_PETUGAS }}" {{ $penjualan->ID_PETUGAS == $p->ID_PETUGAS ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select name="ID_PELANGGAN" class="form-select" required>
                        ...
                        @foreach($pelanggan as $pl)
                            <option value="{{ $pl->ID_PELANGGAN }}" {{ $penjualan->ID_PELANGGAN == $pl->ID_PELANGGAN ? 'selected' : '' }}>
        ...
        <div class="form-row">
            <div class="form-col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="SUBTOTAL" id="input_subtotal" class="form-control" value="{{ $penjualan->SUBTOTAL }}" required min="0" step="0.01">
                    </div>
                </div>
            </div>
            <div class="form-col">
            ...
            <div class="form-col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">Rp</span>
                        <input type="number" name="total" id="input_total" class="form-control" value="{{ $penjualan->TOTAL }}" readonly style="background-color: #e2e8f0;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-col" style="flex: 0.33;">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">Rp</span>
                        <input type="number" name="SISA_TAGIHAN" class="form-control" value="{{ $penjualan->SISA_TAGIHAN }}" required min="0" step="0.01">
                    </div>
                </div>
            </div>
            <div class="form-col" style="flex: 0.67;">
                <div class="form-group">
                    ...
                    <textarea name="PESAN" class="form-control" rows="2">{{ $penjualan->PESAN }}</textarea>
                </div>
            </div>
        </div>

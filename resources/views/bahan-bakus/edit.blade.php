...
<div class="form-container">
    <div class="form-header">
        <h3><i class="fas fa-edit"></i> Form Edit Bahan Baku</h3>
    </div>
    ...
    <form action="{{ route('bahan-bakus.update', $data->ID_BAHAN_BAKU) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-row">
            <div class="form-col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $data->ID_BAHAN_BAKU }}" readonly>
                </div>
            </div>
            <div class="form-col">
                <div class="form-group">
                    <label class="form-label">Kode Bahan <span>*</span></label>
                    <input type="text" name="kode" class="form-control" value="{{ old('kode', $data->KODE) }}" required autocomplete="off">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="jenis" class="form-control" value="{{ old('jenis', $data->JENIS) }}" required autocomplete="off">
            <small style="color: #94a3b8; font-size: 11px;">Nama bahan baku yang akan digunakan</small>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="stok" class="form-control" value="{{ old('stok', $data->STOK) }}" required autocomplete="off">
        </div>

...
@section('content')
<style>
    /* sama persis dengan style di atas, gunakan styling yang sama */
    .form-container {
        background: #ffffff;
        border-radius: 20px;
...
<div class="form-container">
    <div class="form-header">
        <h3><i class="fas fa-user-edit"></i> Form Edit Pelanggan</h3>
    </div>
  ...
  <form action="{{ route('pelanggans.update', $pelanggan->ID_PELANGGAN) }}" method="POST">
    ...
    @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_pelanggan" class="form-control" value="{{ old('nama_pelanggan', $pelanggan->NAMA_PELANGGAN) }}" required autocomplete="off">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="no_telp" class="form-control" value="{{ old('no_telp', $pelanggan->NO_TELP) }}" required autocomplete="off" maxlength="20">
        </div>

        <div class="form-group">
            <label class="form-label">Fax <span class="optional">(opsional)</span></label>
            <input type="text" name="fax" class="form-control" value="{{ old('fax', $pelanggan->FAX) }}" autocomplete="off" maxlength="20">
        </div>
